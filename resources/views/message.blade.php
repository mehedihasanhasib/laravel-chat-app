                                ...
                                <div class="col-start-1 col-end-8 p-3 rounded-lg">
                                    <div class="flex flex-row items-center">
                                        ...
                                        <div class="relative ml-3 text-sm bg-white py-2 px-4 shadow rounded-xl">
                                            <div id="newChat">Hey How are you today?</div>
                                        </div>
                                    </div>
                                </div>
...
<script>
    setTimeout(() => {
        window.Echo.channel('newMessage').listen('.App\\Events\\NewMessage', (e) => {
            document.getElementById('newChat').innerHTML = e.newChat;
        })
    }, 200);
</script>
